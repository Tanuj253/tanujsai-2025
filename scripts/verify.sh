...
export project=\$project_dir/csa  # change portfolio_2025 to name of project from git clone
export project_repo="https://github.com/Tanuj253/studentcsa.git"  # change to project you created from portfolio_2025 template 
EOF
